...
const Navigation = () => {
    ...
    return (
        <div className=" w-full max-w-full overflow-x-hidden">
            <header className="bg-white md:bg-transparent  fixed z-50 top-0 w-full py-2 md:py-4 px-4 border-b border-b-input lg:border-none md:px-12">
                <nav className=" w-full items-center flex justify-between">
                    <div className="flex items-center gap-20">
                        <div className=" hidden md:block items-start gap-1">
