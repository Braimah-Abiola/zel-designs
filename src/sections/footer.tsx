        ...
        <footer className=" bg-black pb-12">
            <Wrapper>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 mt-6 md:mt-24">
                    ...
                    <div className="flex flex-col items-start text-base md:text-lg gap-4">
                        <Magnetic>
                            <Link href="https://builtwithatlas.com/meeting-iq" target="_blank" className=" flex items-center gap-2 text-white">
                                <ArrowRight />
                                <p>Meeting IQ</p>
                            </Link>
                        </Magnetic>
                        <Magnetic>
                            <Link href="https://www.stakenet.app/" target="_blank" className=" flex items-center gap-2 text-white">
                                <ArrowRight />
                                <p>Stakenet</p>
                            </Link>
                        </Magnetic>
                        <Magnetic>
                            <Link href="https://www.astrae.design" target="_blank" className=" flex items-center gap-2 text-white">
                                <ArrowRight />
                                <p>Astrae Designs</p>
                            </Link>
                        </Magnetic>
                        <Magnetic>
                            <Link href="https://02-galileo.vercel.app/" target="_blank" className=" flex items-center gap-2 text-white">
                                <ArrowRight />
                                <p>Midas Inc</p>
                            </Link>
                        </Magnetic>
                        <Magnetic>
                            <Link href="https://www.genysolutions.tech/" target="_blank" className=" flex items-center gap-2 text-white">
                                <ArrowRight />
                                <p>GenYSolutions</p>
                            </Link>
                        </Magnetic>
                    ...
                    <Link className=" w-full col-span-2 group" href="https://calendly.com/denzelobeng421/30min">
                        <div className=" w-full mt-6 md:mt-0 h-full bg-muted hover:bg-muted/80 min-h-[10rem] rounded-xl relative">
                            ...
                            <Button size="icon" className=" group-hover:rotate-45 ease-in-out transition-transform duration-500 bg-white hover:bg-white text-foreground hover:text-foreground absolute bottom-4 right-4 md:bottom-12 md:right-12"><ArrowUpRight className=" size-6" /></Button>
                        </div>
                    </Link>
