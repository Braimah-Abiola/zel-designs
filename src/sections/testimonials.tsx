            ...
            <Wrapper>
                ...
                <div className=" w-full mt-28 flex flex-col gap-20">
                    ...
                    <div className=" py-12 relative flex flex-row justify-between">
                        ...
                        <div className=" flex flex-col items-start mt-6 w-[280px]">
