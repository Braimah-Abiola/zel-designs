...
const Works = () => {
    return (
        <div className=" w-full px-4 md:px-12 pt-40">
            <div className=" w-full flex items-center justify-between uppercase font-clashDisplay font-semibold text-4xl md:text-7xl">
                    ...
                    <div className=" w-full flex flex-col group">
                        ...
                        <div className="flex items-center justify-between w-full">
                            <div>
                                ...
                                <p className=" text-foreground/70 mt-2 text-base md:text-lg">Beautifully crafted Next.js template store</p>
                            </div>
                    ...
                    <div className=" w-full flex flex-col group">
                        ...
                        <div className="flex items-center justify-between w-full">
                            <div>
                                ...
                                <p className=" text-foreground/70 mt-2 text-base md:text-lg">AI-powered insights for smarter sales prep</p>
                            </div>
                    ...
                    <div className=" w-full flex flex-col group">
                        ...
                        <div className="flex items-center justify-between w-full">
                            <div>
                                ...
                                <p className=" text-foreground/70 mt-2 text-base md:text-lg">AI-powered bet slips analyzer for accurate prediction</p>
                            </div>
                            <div className="flex flex-wrap gap-2">
                                <div className="flex gap-2 items-center px-4 py-1 rounded-full border border-black/40 uppercase">
                                    <TvMinimal className=" size-4" />
