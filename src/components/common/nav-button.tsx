...
const NavButton = ({ text }: { text: string }) => {
    return (
        <button className="group w-fit text-base overflow-clip cursor-pointer flex h-11 py-2 items-center rounded-full bg-[#ECECEC] pl-5 pr-7 transition-all duration-300 ease-in-out hover:bg-primary hover:pl-2 hover:pr-5 hover:text-foreground">
